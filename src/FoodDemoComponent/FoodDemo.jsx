    ...
    <section className="demo-main">
      ...
      <section className="demo-detail">
        <div className="demo-img">
          <span className="demo-img1">
            <span className="img" data-aos="flip-right"></span>
            <span className="img2" data-aos="flip-left"></span>
          </span>
        ...
        <div className="demo-head">
            ...
            <div className="demo-head-detail">
              <span className="demo-h1">
                ...
                <p className="de-h1-p">A Sophisticated & Traditional<br/> Cuisine</p>
              </span>
